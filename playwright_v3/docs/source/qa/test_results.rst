...
.. csv-table::
   ...
   "TC-UI-ROOMS-003", "REQ-UI-ROOMS-03", "delete a room via the UI, verify it disappears", "✗", "28.54"
   "TC-UI-NAV-003", "REQ-UI-NAV-03", "Logout ends the admin session", "✗", "13.40"
   "TC-UI-RES-003", "REQ-UI-RES-02", "select dates and complete a reservation booking", "✗", "13.31"
   "—", "—", "test_reminder_ui_layer_once_targeted_a_sut_that_no_longer_existed", "S", "0.00"
   "TC-UI-LOGIN-002", "REQ-UI-LOGIN-02", "invalid admin credentials -> 'Invalid credentials', stays on the form", "✓", "15.06"
   "TC-UI-LOGIN-003", "REQ-UI-LOGIN-03", "login form placeholders ('Enter username' / 'Password')", "✓", "10.25"
   "TC-UI-LOGIN-001", "REQ-UI-LOGIN-01", "valid admin credentials log in", "✓", "17.73"
   "TC-UI-NAV-002", "REQ-UI-NAV-02", "admin brand text is 'Restful Booker Platform Demo'", "✓", "9.24"
   "TC-UI-BRAND-001", "REQ-UI-BRAND-01", "branding page shows B&B name, description and contact name", "✓", "9.87"
   "TC-UI-ROOMS-002", "REQ-UI-ROOMS-02", "create a room via the UI, verify it appears", "✓", "14.69"
   "TC-UI-MSG-001", "REQ-UI-MSG-01", "messages page lists messages with name and subject", "✓", "13.68"
   "TC-UI-NAV-001", "REQ-UI-NAV-01", "post-login navbar shows Rooms / Report / Branding / Messages / Front Page", "✓", "13.22"
   "TC-UI-REPORT-001", "REQ-UI-REPORT-01", "report page loads a calendar view", "✓", "13.75"
   "TC-UI-ROOMS-001", "REQ-UI-ROOMS-01", "rooms table lists existing rooms (101/102/103) + Create button", "✓", "9.78"
   "TC-UI-HOME-004", "REQ-UI-HOME-04", "admin link points to /admin", "✓", "13.05"
   "TC-UI-RES-001", "REQ-UI-RES-01", "each room 'Book now' link points at /reservation/{id}", "✓", "13.20"
   "TC-UI-CONTACT-002", "REQ-UI-CONTACT-02", "empty contact form -> field-validation errors", "✓", "13.57"
   "TC-UI-CONTACT-001", "REQ-UI-CONTACT-01", "contact form valid submit -> confirmation", "✓", "13.98"
   "TC-UI-HOME-001", "REQ-UI-HOME-01", "the home page footer is present", "✓", "9.06"
   "TC-UI-HOME-002", "REQ-UI-HOME-02", "the four footer links - texts + hrefs", "✓", "13.64"
   "TC-UI-HOME-005", "REQ-UI-HOME-01", "navbar brand text is 'Shady Meadows B&B'", "✓", "13.15"
   "TC-UI-HOME-003", "REQ-UI-HOME-03", "nav links are section anchors (/#rooms, /#booking, etc.)", "✓", "12.93"
...
.. csv-table::
   ...
   "TC-UI-ROOMS-003", "✗", "TestAdminNavigation::test_delete_room_removes_it_from_the_table[setup_and_teardown0]", "28.54", "selenium.common.exceptions.TimeoutException: Message:"
   "TC-UI-NAV-003", "✗", "TestAdminNavigation::test_logout_leaves_the_admin_area[setup_and_teardown0]", "13.40", "assertpy2.AssertionFailure: Expected <True> to be <False>, but was not."
   "TC-UI-RES-003", "✗", "TestHomePage::test_reservation_booking_completes_with_valid_dates[setup_and_teardown0]", "13.31", "AssertionError: precondition: no selectable calendar days assert []"
   "—", "S", "tests/web_app_tests/test_sut_drift_episode.py::test_reminder_ui_layer_once_targeted_a_sut_that_no_longer_existed", "0.00", "EPISODE 1 (resolved M8): the whole Selenium UI layer was written against the 202"
   "TC-UI-LOGIN-002", "✓", "TestAdminLogin::test_invalid_credentials_are_rejected[setup_and_teardown0]", "15.06", ""
   "TC-UI-LOGIN-003", "✓", "TestAdminLogin::test_login_form_placeholders[setup_and_teardown0]", "10.25", ""
   "TC-UI-LOGIN-001", "✓", "TestAdminLogin::test_valid_credentials_log_in[setup_and_teardown0]", "17.73", ""
   "TC-UI-NAV-002", "✓", "TestAdminNavigation::test_brand_text[setup_and_teardown0]", "9.24", ""
   "TC-UI-BRAND-001", "✓", "TestAdminNavigation::test_branding_page_shows_bb_details[setup_and_teardown0]", "9.87", ""
   "TC-UI-ROOMS-002", "✓", "TestAdminNavigation::test_create_room_adds_it_to_the_table[setup_and_teardown0]", "14.69", ""
   "TC-UI-MSG-001", "✓", "TestAdminNavigation::test_messages_page_lists_submissions[setup_and_teardown0]", "13.68", ""
   "TC-UI-NAV-001", "✓", "TestAdminNavigation::test_navbar_links[setup_and_teardown0]", "13.22", ""
   "TC-UI-REPORT-001", "✓", "TestAdminNavigation::test_report_page_shows_calendar[setup_and_teardown0]", "13.75", ""
   "TC-UI-ROOMS-001", "✓", "TestAdminNavigation::test_rooms_table_lists_rooms[setup_and_teardown0]", "9.78", ""
   "TC-UI-HOME-004", "✓", "TestHomePage::test_admin_links_point_to_admin[setup_and_teardown0]", "13.05", ""
   "TC-UI-RES-001", "✓", "TestHomePage::test_book_now_links_point_at_reservation_pages[setup_and_teardown0]", "13.20", ""
   "TC-UI-CONTACT-002", "✓", "TestHomePage::test_contact_form_shows_validation_errors_when_empty[setup_and_teardown0]", "13.57", ""
   "TC-UI-CONTACT-001", "✓", "TestHomePage::test_contact_form_valid_submit_shows_confirmation[setup_and_teardown0]", "13.98", ""
   "TC-UI-HOME-001", "✓", "TestHomePage::test_footer_is_present[setup_and_teardown0]", "9.06", ""
   "TC-UI-HOME-002", "✓", "TestHomePage::test_footer_links[setup_and_teardown0]", "13.64", ""
   "TC-UI-HOME-005", "✓", "TestHomePage::test_nav_brand[setup_and_teardown0]", "13.15", ""
   "TC-UI-HOME-003", "✓", "TestHomePage::test_nav_links_are_section_anchors[setup_and_teardown0]", "12.93", ""
   "TC-UI-A11Y-001", "✓", "TestHomePage::test_page_has_lang_attribute[setup_and_teardown0]", "8.93", ""
   "TC-UI-RES-002", "✓", "TestHomePage::test_reservation_page_shows_calendar_and_reserve_button[setup_and_teardown0]", "13.73", ""
